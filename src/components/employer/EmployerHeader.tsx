...
export function EmployerHeader({ onSidebarToggle, isSidebarOpen }: EmployerHeaderProps) {
      ...
      <div className="flex items-center justify-between h-16 px-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-lg font-bold text-gray-900 hidden sm:block">Job Genie</span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative" ref={profileRef}>
            ...
            {showProfileDropdown && (
              <Card className="absolute right-0 mt-2 w-56 shadow-lg border-0 z-50">
